    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <img src={{$user->profile->image_path}} alt="Profile picture" class='card'>
            </div>
            <h2>{{ $user->username }}</h2>
        ...
        <div class="form-group row">
            <form action="/admin/{{ $user->id }}" method="POST">
                ...
                <button
                    type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">DELETE this user</button>
